on open of fichiers
	...
	set cheminTemp to "/tmp/temp." & (random number from 0 to 1000000) & ".publie"
	...
	tell application "Terminal"
		set fenetre to do script dirname & "/Publie.sh " & cheminTemp & " ; exit"
		repeat until fenetre's history contains "Publie"
			delay 1
		end repeat
		delay 1
